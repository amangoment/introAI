...
\author{Mange Chen}        % Enter your name between curly braces
...
\\ Scan each room: 4*12 = 48
\\ Shortest route: 2 + 7 + 2 + 2 + 2 + (2 + 2) + 2 + 2 + 2 + 2 + 2 + (2) + 2 + 2 = 35
\\ The number with parenthese means depulicate routes.
\\ Total number is: 48 + 35 = 83 minutes
...
\\ 83/45 = 1.84
\\ We need two batteries for scanning the floor.
...
\\ See graph.py and I convert capitals to numbers as below.
